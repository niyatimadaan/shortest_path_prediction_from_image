...
img = cv2.imread('New folder\Files\Image1.png') # read an image from a file using opencv (cv2) library
p = find_shortest_path(img, (1017,891), (738,259))
drawPath(img,p,9 )
cv2.circle(img,(1017,891), 3, (255,0,0), -1) # add a circle at (5, 220)
cv2.circle(img, (738,259), 3, (0,0,255), -1) # add a circle at (5,5)
plt.figure(figsize=(7,7))
plt.imshow(img) # show the image on the screen
plt.show()

# img = cv2.imread('Image1.png') # read an image from a file using
#
# plt.figure(figsize=(7,7))
